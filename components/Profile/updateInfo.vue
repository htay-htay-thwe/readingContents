<template>
    <div>
        ...
        <div v-show="infoModal == true" class="relative z-10" aria-labelledby="modal-title" role="dialog"
            aria-modal="true">
...
export default {
    ...
    setup(props) {
        ...
        const Submit = handleSubmit(async (values) => {
            ...
            try {
                const res = await api.post(`userAuth/update/user/information`, formData, {
                    headers: {
