<template>
    <div v-if="!loading">
        <div class="flex flex-col max-w-xl gap-10 mx-auto mt-10 sm:max-w-3xl md:max-w-4xl lg:max-w-5xl sm:flex-row">
            <div class="gap-10 mx-auto mt-10 ">
                ...
                <div @click="toggleInfo()" class="mt-3"><button
                        class="w-48 p-2 font-mono rounded-md hover:text-zinc-500 bg-zinc-300">Edit
                        Profile</button></div>
            ...
            <div v-show="imageModal == true" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" aria-hidden="true"></div>
    <div class="fixed inset-0 z-10 flex items-center justify-center w-screen p-3 overflow-y-auto">
        <form @submit.prevent="onSubmit" class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:w-full sm:max-w-lg">
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Are you sure you want to upload your photo? All of your data will be permanently updated.</p>
                        </div>
                        <div class="mb-4">
                            <label class="block mt-4 mb-2 text-sm font-bold text-gray-700" for="image">
                                Profile Photo
                            </label>
                            <input @change="handleFileUpload" name="image" class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" id="image" type="file">
            ...
            <div class="px-4 py-3 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="submit" class="inline-flex justify-center w-full px-3 py-2 text-sm font-semibold text-white bg-green-400 rounded-md shadow-sm hover:text-zinc-600 sm:ml-3 sm:w-auto">Submit</button>
                <button @click="toggleImage()" type="button" class="inline-flex justify-center w-full px-3 py-2 mt-3 text-sm font-semibold text-gray-900 bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
            </div>
        </form>
    </div>
</div>
